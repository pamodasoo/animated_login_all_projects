...
<div id="top-nav" class="navbar navbar-inverse navbar-static-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">Green Light Hospital</a>
        </div>
...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
    ...
    <ul class="nav nav-pills nav-stacked" style="border-right:1px solid black">
        ...
        <li><a href="#"><i class="fa fa-tags"></i>Delete Users</a></li>
        <li><a href="#"><i class="fa fa-history"></i>Update Users</a></li>
...
<div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
    ...
    <a href="#"><strong><span class="fa fa-dashboard"></span> </strong></a>
    <hr>
</div>