      ...
      <h3>Enter Information</h3>
                <?php
                  if(isset($_POST['apfullname'])){
                    $i = enter_patient_info($_SESSION["user_id"],$_POST['apfullname'],$_POST['apAge'],$_POST['apphone_no'],$_POST['apaddress']);

                    appointment_booking($_SESSION["user_id"], $_POST['apSpecialist'], 
                      $_POST['apCondition']);

                    unset($_POST['apfirstname']); //unset all post variables
                    if (isset($_POST['apfirstname'])){
                      echo '<script type="text/javascript">location.reload();</script>';
                    }

                  }
                ?>
            <form action="add_patient.php" method="POST" class="col col-xl-6 col-sm-6">
